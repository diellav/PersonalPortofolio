...
function Hero() {
  ...
  return (
    <header className="p-8 overflow-hidden">
      ...
      <div className="container mx-auto grid h-full gap-10 min-h-[60vh] w-full grid-cols-1 items-center justify-items-center lg:grid-cols-2">
        <div className="relative  typewriter sm:row-start-2 md:row-start-2  lg:row-auto sm:w-[90%]">
          ...
          <p className="type font-mono mb-4 leading-loose text-lg text-text md:pr-16 xl:pr-28 text-shadow-[0_0_10px_rgba(0,120,255,0.5)]">
              Welcome to my little corner of the internet where I share my projects, experiments, and what I’m learning along the way.
          </p>
          <a href="#projects"
  ...
  className="sm:row-start-1 md:row-start-1  lg:row-auto w-full
