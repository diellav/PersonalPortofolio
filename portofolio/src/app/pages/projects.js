...
const projects = [
  ...
  id: 2,
  title: "TherapyTalks",
  description: "Worked as a duo-team to create an online mental health platform enabling users to connect with licensed professionals via booking, real-time chat, and secure online consultations, while allowing professionals to manage their services. The platform is designed to provide accessible, private, and user-friendly mental health support for both clients and professionals.",
  image: "/images/tthomepage.png",
  github: "https://github.com/Lea-M04/TherapyTalks",
  techStack: ["NextJs", "Laravel", "PHP", "MySQL", "Jitsi", "Stripe"],
  screenshots: [
    { src: "/images/tthomepage.png", description: "Home Page" },
    { src: "/images/tthomepage2.png", description: "Home Page" },
    { src: "/images/tthomepage3.png", description: "Home Page" },
    { src: "/images/ttsignin.png", description: "Patient & Professional Sign In" },
    { src: "/images/ttcomplete.png", description: "Complete Profile" },
    { src: "/images/ttverify.png", description: "Profesional verification request" },
    { src: "/images/ttprofesionals.png", description: "Search Professionals" },
    { src: "/images/ttdetails.png", description: "Professional Details and Start Chat" },
    { src: "/images/ttdetails2.png", description: "Services and Availability" },
    { src: "/images/ttbook.png", description: "Book Consultation" },
    { src: "/images/ttbookingsmore.png", description: "Patient Consultations" },
    { src: "/images/ttchat.png", description: "Professional-Patient Chat Room" },
    { src: "/images/ttconfirm.png", description: "Consultation Confirm by Professional" },
    { src: "/images/ttnotifications.png", description: "Notifications" },
    { src: "/images/ttdashboard1.png", description: "Admin Dashboard" },
    { src: "/images/ttdashboard2.png", description: "Admin Dashboard" },
    { src: "/images/ttjitsi.png", description: "Online Consultation (Jitsi)" },
  ],
}
,
  {
  ...
  return (
    ...
    Projects
      ...
      project.id % 2 === 0 ? "sm:-mt-4 md:-mr-16 lg:-mr-48" : "sm:-mt-4 md:-ml-16 lg:-ml-48"}`}>
              ...
              <p className="text-white lg:text-sm sm:text-base text-base font-mono text-center leading-relaxed">{project.description}</p>
